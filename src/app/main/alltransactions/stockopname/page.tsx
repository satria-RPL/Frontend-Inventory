...
import OpnameTableView from "@/components/sections/OpnameTableView";
  ...
  return (
    <div className="min-h-screen space-y-6 p-4">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-medium">Stock Opname</h1>
      ...
      <div className="w-full">
        <div className="flex flex-wrap items-end gap-6 p-4 rounded-lg border-2 border-gray-200 bg-white">
          ...
          <div className="flex flex-col gap-1 px-5">
            ...
            <div className="relative p-0.5 w-50 z-30">
              <DatePicker
                selected={dateFrom}
