...
export default function PurchaseReportPage() {
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      {/* Title */}
      <div className="mb-5">
        <h1 className="text-xl font-semibold text-gray-800">Laporan Purchase</h1>
      </div>
      ...
      <div className="mb-6 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between">
            ...
            <DollarSign size={30} className="text-gray-300" />
          </div>
        </div>
        <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between">
      ...
      <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        <div className="mb-4 grid grid-cols-2 gap-4 md:grid-cols-4">
          {/* Item Filter */}
          <div>
            <label className="mb-2 block text-xs font-medium text-gray-700">Item</label>
            <input
              type="text"
              placeholder="Cari SKU"
              className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-600 placeholder:text-gray-400"
            />
          </div>

          {/* Category Filter */}
          <div>
            <label className="mb-2 block text-xs font-medium text-gray-700">Kategori</label>
